...
//   ]
    timeline_variables:
        [
        { video: ['video/1-Welcome_to_our_language_learni.mp4']},
        { video: ['video/2-And_my_name_is_Henry.mp4']},
        { video: ['video/3-In_this_game-_you_will_listen_.mp4']},
        { video: ['video/4-In_this_first_part-_you_will_s.mp4']}
    ]
};
...
//   ]
    timeline_variables:
        [
        { video: ['video/5-Great_Job_with_level_1-_You_ar.mp4']},
        { video: ['video/6-_In_this_part-_you_will_guess_.mp4']},
        { video: ['video/7-or_I-_Henry-_would_describe_th.mp4']},
        { video: ['video/8-Here_we_go-.mp4']}
    ]
};
...
//   ]
    timeline_variables:
        ...
        { video: ['video/10-Great_job_with_level_2-_You_ar.mp4']},
